...
const ALREADY = G.FB_HEIGHT[3] === 5.3;
const MAP = ALREADY
  ? new Map([[0.06, 0.06], [1.3, 1.3], [3.3, 3.3], [3.9, 3.9], [5.3, 5.3], [5.7, 5.7], [7.3, 7.3], [10.3, 10.3]])
  : new Map([[0.06, 0.06], [1.3, 1.3], [2.2, 3.3], [2.8, 3.9], [3.6, 5.3], [4, 5.7], [5.6, 7.3], [8.6, 10.3]]);
...
const CELLS_H = G.FB_CELL_HEIGHTS.map((row, r) => row.map((h, c) => (wallRestoreSet.has(c + "," + r) ? 5.3 : gapSet.has(c + "," + r) ? null : remap(h))));
