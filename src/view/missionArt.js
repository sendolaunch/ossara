...
const SPAWN_DRESSING = {
  ...
  "northwest-stairs": {
    ry: 90,
    props: [
      { name: "wall_archedwindow_gated", dx: -0.75, dz: 0, scale: 1.08, ry: 90 },
      { name: "stairs_wide", dx: 1.4, dz: 2.05, scale: 0.72, ry: 0 },
      { name: "banner_thin_green", dx: 0.85, dz: -2.35, scale: 0.72, ry: 90 },
      { name: "torch_lit", dx: -1.25, dz: -1.55, scale: 0.66 },
      { name: "rocks_decorated", dx: 2.85, dz: 2.1, scale: 0.58, ry: -22 },
      { name: "rubble_large", dx: 1.85, dz: -2.55, scale: 0.52, ry: 16 },
    ],
  },
  "northeast-market": {
    ry: -90,
    props: [
      ...
      { name: "banner_thin_green", dx: -0.85, dz: -2.35, scale: 0.72, ry: -90 },
      { name: "torch_lit", dx: 1.25, dz: -1.55, scale: 0.66 },
      { name: "crate_large_decorated", dx: -2.45, dz: -1.65, scale: 0.64, ry: 18 },
      { name: "barrel_small_stack", dx: -2.55, dz: 1.25, scale: 0.58, ry: -12 },
      { name: "table_medium_broken", dx: -3.35, dz: 2.35, scale: 0.62, ry: 38 },
    ],
  },
  "southwest-crypt": {
    ry: 90,
...
const BACKGROUND_DRESSING = [
  { id: "north-left-broken-wall", name: "wall_broken", col: 43, row: 7, dx: 0, dz: 0, scale: 0.92, ry: 12 },
  { id: "north-right-cracked-wall", name: "wall_cracked", col: 77, row: 7, dx: 0, dz: 0, scale: 0.92, ry: -12 },
  { id: "west-low-barrier", name: "barrier_half", col: 22, row: 45, dx: 0, dz: 0, scale: 0.9, ry: 90 },
  { id: "east-low-barrier", name: "barrier_half", col: 98, row: 45, dx: 0, dz: 0, scale: 0.9, ry: 90 },
  { id: "south-left-pillar", name: "pillar_decorated", col: 42, row: 82, dx: 0, dz: 0, scale: 0.72, ry: 8 },
  { id: "south-right-pillar", name: "pillar_decorated", col: 78, row: 82, dx: 0, dz: 0, scale: 0.72, ry: -8 },
  { id: "market-crates", name: "crates_stacked", col: 95, row: 31, dx: 1.8, dz: -1.9, scale: 0.62, ry: 24 },
  { id: "market-barrels", name: "barrel_large_decorated", col: 90, row: 35, dx: -2.0, dz: 2.0, scale: 0.58, ry: -18 },
  { id: "crypt-candles", name: "shelf_small_candles", col: 36, row: 59, dx: -1.8, dz: 1.8, scale: 0.58, ry: 30 },
  { id: "garden-rocks", name: "rocks_small", col: 84, row: 58, dx: 2.0, dz: 1.5, scale: 0.72, ry: -28 },
  { id: "field-map", name: "rpgtools/map", col: 60, row: 37, dx: -5.0, dz: -1.5, scale: 0.62, ry: -8 },
  { id: "field-journal", name: "rpgtools/journal_open", col: 60, row: 37, dx: -4.25, dz: -1.2, scale: 0.5, ry: 14 },
];
