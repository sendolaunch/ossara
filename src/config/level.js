...
export const LANES = [
  {
    ...
    waypoints: [ { col: 22, row: 6 }, { col: 22, row: 7 }, { col: 22, row: 29 }, { col: 22, row: 51 }, { col: 9, row: 51 } ],
    choke: { col: 22, row: 29 },
    fallbackChoke: { col: 22, row: 51 },
    buildShoulders: [ { col: 18, row: 28 }, { col: 26, row: 28 }, { col: 18, row: 27 }, { col: 26, row: 27 } ],
    threatRating: 1,
    telegraphs: [],
  },
  {
    ...
    spawn: { col: 5, row: 6 },
    spawnWidth: 3.1, spawnSpreadFade: 13, corridorWidth: 2.6,
    waypoints: [ { col: 5, row: 6 }, { col: 5, row: 7 }, { col: 9, row: 7 }, { col: 9, row: 29 }, { col: 9, row: 51 } ],
    choke: { col: 9, row: 29 },
    fallbackChoke: { col: 9, row: 29 },
    buildShoulders: [ { col: 5, row: 29 }, { col: 5, row: 28 }, { col: 5, row: 30 }, { col: 5, row: 27 } ],
    threatRating: 1,
    telegraphs: [],
  },
  {
    ...
    waypoints: [ { col: 65, row: 7 }, { col: 65, row: 9 }, { col: 48, row: 9 }, { col: 48, row: 32 }, { col: 31, row: 32 }, { col: 14, row: 32 }, { col: 14, row: 51 }, { col: 9, row: 51 } ],
    choke: { col: 31, row: 32 },
    fallbackChoke: { col: 14, row: 51 },
    buildShoulders: [ { col: 29, row: 28 }, { col: 28, row: 28 }, { col: 27, row: 28 }, { col: 27, row: 36 } ],
    threatRating: 2,
    telegraphs: [],
  },
  {
    ...
    spawn: { col: 66, row: 30 },
    spawnWidth: 3.1, spawnSpreadFade: 13, corridorWidth: 2.6,
    waypoints: [ { col: 66, row: 30 }, { col: 49, row: 30 }, { col: 31, row: 30 }, { col: 31, row: 44 }, { col: 9, row: 44 }, { col: 9, row: 51 } ],
    choke: { col: 49, row: 30 },
    fallbackChoke: { col: 9, row: 44 },
    buildShoulders: [ { col: 50, row: 34 }, { col: 51, row: 34 }, { col: 52, row: 26 }, { col: 52, row: 34 } ],
    threatRating: 1,
    telegraphs: [],
  },
  {
    ...
    spawn: { col: 66, row: 52 },
    spawnWidth: 3.1, spawnSpreadFade: 13, corridorWidth: 2.6,
    waypoints: [ { col: 66, row: 52 }, { col: 38, row: 52 }, { col: 9, row: 52 }, { col: 9, row: 51 } ],
    choke: { col: 38, row: 52 },
    fallbackChoke: { col: 38, row: 52 },
    buildShoulders: [ { col: 38, row: 48 }, { col: 37, row: 48 }, { col: 39, row: 48 }, { col: 36, row: 48 } ],
    threatRating: 1,
    telegraphs: [],
  },
];
...
export const LEVEL = {
  ...
  buildableZones: [
    ...
    { id: "north-gate-build", laneId: "north-gate", col: 19, row: 26, w: 7, h: 7 },
    { id: "northwest-stairs-build", laneId: "northwest-stairs", col: 6, row: 26, w: 7, h: 7 },
    { id: "northeast-market-build", laneId: "northeast-market", col: 28, row: 29, w: 7, h: 7 },
    { id: "southwest-crypt-build", laneId: "southwest-crypt", col: 46, row: 27, w: 7, h: 7 },
    { id: "southeast-garden-build", laneId: "southeast-garden", col: 35, row: 49, w: 7, h: 7 },
  ],
