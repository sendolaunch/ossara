export const MAP_THEMES = Object.freeze({
  ruined_ward_courtyard_v1: {
    ...
    lighting: {
      ...
      sunColor: "#ecdfc0",
      sunIntensity: 1.15,
      sunEuler: { x: 36, y: 44, z: 0 },
      fogColor: "#14151c",
      fogStart: 16,
      fogEnd: 74,
      spawnLight: { color: "plague", intensity: 1.05, range: 8 },
      coreLight: { color: "plague", intensity: 1.15, range: 9 },
    },
    materialTokens: {
      ruinedStoneDark: { color: "#302e2a", emissive: 0.01, gloss: 0.16 },
      ruinedStoneMid: { color: "#5d5a51", emissive: 0.018, gloss: 0.26 },
      ruinedStoneStep: { color: "#7a7568", emissive: 0.034, gloss: 0.3 },
      courtyardLowStone: { color: "#2a2825", emissive: 0.006, gloss: 0.13 },
      courtyardMidStone: { color: "#524d45", emissive: 0.012, gloss: 0.28 },
      landingHighStone: { color: "#706b60", emissive: 0.025, gloss: 0.3 },
      shrinePlatformStone: { color: "#565249", emissive: 0.055, gloss: 0.3 },
      floorRubbleDark: { color: "#2a2723", emissive: 0.004, gloss: 0.14 },
