export const MAP_THEMES = Object.freeze({
  ruined_ward_courtyard_v1: {
    ...
    lighting: {
      ...
      coreLight: { color: "plague", intensity: 2.45, range: 17 },
    },
    materialTokens: {
      ...
      laneStoneBed: { color: "#3b412e", emissive: 0.025, opacity: 0.26, gloss: 0.16, depthWrite: false },
      lanePlagueSeam: { color: "plague", emissive: 0.34, opacity: 0.14, gloss: 0.18, depthWrite: false },
      laneDirectionGold: { color: "gold", emissive: 0.32, opacity: 0.24, gloss: 0.26, depthWrite: false },
      pathTileStone: { color: "rot", emissive: 0.08, opacity: 0.25, gloss: 0.14, depthWrite: false },
      buildableGoldSoft: { color: "gold", emissive: 0.08, opacity: 0.1, gloss: 0.16, depthWrite: false },
      mainChokeGold: { color: "gold", emissive: 0.46, opacity: 0.22, gloss: 0.28, depthWrite: false },
      chokeReadabilityGreen: { color: "plague", emissive: 0.58, opacity: 0.2, gloss: 0.24, depthWrite: false },
      spawnThresholdBlood: { color: "blood", emissive: 0.42, opacity: 0.24, gloss: 0.2, depthWrite: false },
      spawnGateWardRing: { color: "plague", emissive: 0.85, opacity: 0.34, gloss: 0.22, depthWrite: false },
      wardApproachGold: { color: "gold", emissive: 0.34, opacity: 0.2, gloss: 0.22, depthWrite: false },
      wardHaloGreen: { color: "plague", emissive: 0.78, opacity: 0.32, gloss: 0.24, depthWrite: false },
    },
    materialAliases: {
